...
class Employee :
    def __init__(self,root) :
        ...
        Main_frame.place(x=0,y=200,width=1850,height=560)
        ...
        upper_frame.place(x=10,y=10,width=1800,height=220)
        ...
        #Add Employee Image
        employeeImg= Image.open('./images/img3.png')
        ...
        down_frame.place(x=10,y=230,width=1800,height=240)
        ...
        search_frame.place(x=0,y=0,width=1800,height=55)
